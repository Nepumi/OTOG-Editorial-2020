...
* **Exponent** คือเลขยกกำลัง (-1022 ถึง 1023) (b)
* **Fraction** คือตัวเลขแมวๆ (a)

ถ้าเป็น **สัญกรณ์วิทยาศาสตร์** จะ Fraction(a) แบบ ฐาน 10 เช่น 1.059 = 1 + 5*10^-2 + 9^10^-3 ไรงี้(เก็บทีละตำแหน่ง)

แต่ถ้าเป็น **สัญกอยณ์วิทยาศาสตร์** จะ Fraction(a) แบบ ฐาน 2 เช่น 1.059 ได้ประมาณ 1 + 2^-5 + 2^-6 + 2^-7 + 2^-8 +2^-12 + 2^-13+ 2^-15
